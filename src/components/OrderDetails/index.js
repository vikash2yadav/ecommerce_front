...
const OrderDetails = () => {
    let { myOrders, totalMyOrders, setMyOrders, getAllMyOrders } = useContext(OrdersContext);
        ...
        <>
            <div className='p-2 flex flex-col md:px-40 px-4 w-full mb-20 '>
                ...
                <p className="text-sm mb-5"><Link to="/my/account" className=" hover:underline hover:text-red-800">Your Account</Link> >
                    <Link to="/my/orders" className="text-red-700 hover:underline hover:text-red-800 mx-1">Your Orders</Link> </p>
                ...
                <div className='flex justify-start items-center mb-5'>
                    <p className='text-sm font-semibold'>{totalMyOrders} orders </p> <span className='mx-1 text-sm'>placed in</span>
                                ...
                                <div className='w-full h-64 rounded-xl border-2 border-gray-200'>
                                    <div className='h-14 text-sm w-full rounded-t bg-gray-200 flex justify-around items-center '>
                                        <div className='flex flex-col md:text-sm text-xs'>
                                            ...
                                            <p>{order?.orderd_date}</p>
                                        </div>
                                        <div className='flex flex-col'>
                                            <p>TOTAL</p>
                                            <p> &#8377; {order?.total_amoumt}</p>
                                        </div>
                                        <div className='flex flex-col'>
                                            <p>SHIP TO</p>
                                            <p> Vikash Yadav</p>
                                    ...
                                    <div className='flex justify-evenly h-40 items-center px-8 '>
                                        <img className='h-28 w-28' src={order?.image} alt="" />
