        ...
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className=" text-gray-200 font-medium">
                ...
                <li className="mb-4">
                  <Link to="/our_choice" className="hover:underline">Our Choices</Link>
                </li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-m font-semibold uppercase text-white">Connect with Us</h2>
              <ul className="text-gray-200 font-medium">
                <li className="mb-4">
                ...
                <li className="mb-4">
                  <a href="https://www.instragram.com" className="hover:underline">Instagram</a>
                </li>
              </ul>
            </div>
            <div>
            ...
            <div>
              <h2 className="mb-6 text-m font-semibold text-white uppercase">
                Let Us Help You</h2>
              <ul className="text-gray-200 font-medium">
                <li className="mb-4">
                  <Link to="/my/account" className="hover:underline">Your Account</Link>
                </li>
                <li className="mb-4">
                  <Link to="/return_centers" className="hover:underline">Return Center</Link>
                </li>
                <li className="mb-4">
          ...
          <div className="px-4 py-6 bg-gray-600 md:flex md:items-center md:justify-between" style={{ backgroundColor: '#131A22' }}>
            ...
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              ...
              <a href="https://www.twitter.com" className="text-white hover:text-gray-200 ">
              ...
              <a href="https://www.github.com/vikash2yadav" className="text-white hover:text-gray-200 ">
