...
const OurChoices = () => {
  return (
    <>
    <div className=' p-4 mb-5 md:w-96' style={{border:'25px solid rgb(229 231 235 )'}} >
   <p className='text-2xl mb-5 font-semibold'>Our choices <span className='text-sm text-roboto hover:underline itms-center text-blue-500'>see more</span></p> 
