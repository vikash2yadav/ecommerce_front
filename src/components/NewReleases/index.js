...
const NewReleases = () => {
  return (
    <>
    <div className=' p-4 mb-5  w-full md:w-96 h-96' style={{border:'25px solid rgb(229 231 235 )'}} >
   <p className='text-2xl mb-5 font-semibold'>New Releases  <span className='text-sm text-roboto hover:underline itms-center text-blue-500'>see more</span></p> 
   
   <div className='flex justify-center flex-wrap h-64 items-center  overflow-x-auto'>

   <div className='w-44 p-4 mx-6'> 
