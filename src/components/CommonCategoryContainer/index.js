...
const CommonCategoryContainer = (props) => {
    return (
        <>
            <div>
                <div className=' p-4 mb-5 w-full' style={{ border: '25px solid rgb(229 231 235 )' }} >
                    <p className='text-2xl mb-5 font-semibold'>Our Best Sellers {props.title} <span className='text-sm text-roboto hover:underline itms-center text-blue-500'><Link to={props.more}>see more</Link></span></p>
...
export default CommonCategoryContainer